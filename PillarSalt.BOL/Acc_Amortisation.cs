...
namespace PillarSalt.BOL
{
    ...
    public partial class Acc_Amortisation
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public Acc_Amortisation()
        {
            this.Acc_Amortisation_Schedule = new HashSet<Acc_Amortisation_Schedule>();
        }
    
        public int Id { get; set; }
        public string Description { get; set; }
        public Nullable<int> InvoiceItemNo { get; set; }
        public Nullable<int> Spread { get; set; }
        public Nullable<decimal> Amount { get; set; }
        public Nullable<int> AdjustedToID { get; set; }
        ...
        public virtual CustomerItinerary CustomerItinerary { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Acc_Amortisation_Schedule> Acc_Amortisation_Schedule { get; set; }
    }
}
