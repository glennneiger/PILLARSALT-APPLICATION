...
namespace PillarSalt.BOL
{
    ...
    public partial class Acc_Amortisation_Schedule
    {
        public int Id { get; set; }
        public Nullable<int> AmortisationId { get; set; }
        public string Description { get; set; }
        public Nullable<decimal> Amount { get; set; }
        public string Month { get; set; }
        public Nullable<System.DateTime> EffectiveDate { get; set; }
        public string Status { get; set; }
        public Nullable<decimal> UnamortisedAmount { get; set; }
        ...
        public virtual Acc_Amortisation Acc_Amortisation { get; set; }
    }
}
