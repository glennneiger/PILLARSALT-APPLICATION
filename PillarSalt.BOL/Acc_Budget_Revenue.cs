...
namespace PillarSalt.BOL
{
    ...
    public partial class Acc_Budget_Revenue
    {
        ...
        public Nullable<decimal> ProjectedIncome { get; set; }
        public Nullable<decimal> BudgetIncome { get; set; }
        ...
        public virtual Acc_Budget_Periods Acc_Budget_Periods { get; set; }
