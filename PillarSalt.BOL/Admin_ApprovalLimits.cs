...
namespace PillarSalt.BOL
{
    ...
    public partial class Admin_ApprovalLimits
    {
        public int Id { get; set; }
        public Nullable<int> PostId { get; set; }
        public Nullable<decimal> CashApprovalLimit { get; set; }
        public Nullable<decimal> CreditApprovalLimit { get; set; }
        public Nullable<decimal> OwnRequestLimit { get; set; }
        ...
        public virtual Acc_Expenses_Limits Acc_Expenses_Limits { get; set; }
    }
}
