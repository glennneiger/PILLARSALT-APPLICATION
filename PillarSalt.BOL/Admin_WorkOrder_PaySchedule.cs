...
namespace PillarSalt.BOL
{
    ...
    public partial class Admin_WorkOrder_PaySchedule
    {
        public int Id { get; set; }
        public Nullable<int> WorkOrderId { get; set; }
        public string Description { get; set; }
        public Nullable<decimal> PercentComplete { get; set; }
        public Nullable<decimal> MinExecutionSpeed { get; set; }
        public Nullable<decimal> CurrentJobQuality { get; set; }
        public Nullable<decimal> PercentInstalment { get; set; }
