...
namespace PillarSalt.BOL
{
    ...
    public partial class CustomeUnbillProfDetail
    {
        public int id { get; set; }
        public Nullable<int> UnbilledProfID { get; set; }
        public Nullable<int> UnbilledItemID { get; set; }
        ...
        public virtual CustomerBillProforma CustomerBillProforma { get; set; }
