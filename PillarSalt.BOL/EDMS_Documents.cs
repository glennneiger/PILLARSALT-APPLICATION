...
namespace PillarSalt.BOL
{
    ...
    public partial class EDMS_Documents
    {
        public int Id { get; set; }
        public string ClientFileName { get; set; }
        public string EDMS_FileName { get; set; }
        public string Description { get; set; }
        public string Extension { get; set; }
        public Nullable<int> Version { get; set; }
        public Nullable<int> TemplateId { get; set; }
        public Nullable<bool> IsTemplateSample { get; set; }
        public Nullable<int> FileSize { get; set; }
        public byte[] FileContent { get; set; }
        public string ReferenceNo { get; set; }
        public string Keywords { get; set; }
        public Nullable<System.DateTime> FileCreationDate { get; set; }
        public Nullable<System.DateTime> FileLastModifiedDate { get; set; }
