...
namespace PillarSalt.BOL
{
    ...
    public partial class HR_Suspensions
    {
        public int Id { get; set; }
        public Nullable<int> StaffId { get; set; }
        public string Description { get; set; }
        public Nullable<int> SuspensionTypeId { get; set; }
        public Nullable<System.DateTime> StartDate { get; set; }
        public Nullable<System.DateTime> EndDate { get; set; }
        public string Notes { get; set; }
        public Nullable<decimal> ProRataDeduction { get; set; }
        public Nullable<int> AssociatedQuery { get; set; }
        ...
        public virtual HR_Queries HR_Queries { get; set; }
        public virtual HR_SuspensionType HR_SuspensionType { get; set; }
