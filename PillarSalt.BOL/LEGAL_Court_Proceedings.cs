...
namespace PillarSalt.BOL
{
    ...
    public partial class LEGAL_Court_Proceedings
    {
        public int Id { get; set; }
        public Nullable<int> LitigationId { get; set; }
        public string Description { get; set; }
        public string Court { get; set; }
        public Nullable<System.DateTime> HearingDate { get; set; }
        public string LeadJury { get; set; }
        public string PlaintiffCounsel { get; set; }
        public string DefenseCounsel { get; set; }
        public Nullable<System.DateTime> Adjournment { get; set; }
        ...
        public virtual LEGAL_Litigation LEGAL_Litigation { get; set; }
    }
}
