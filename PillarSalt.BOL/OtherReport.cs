...
namespace PillarSalt.BOL
{
    ...
    public partial class OtherReport
    {
        ...
        public string HostelMasterReport { get; set; }
        public string CounsellorReport { get; set; }
        public int HealthScore { get; set; }
        public int CounsellorScore { get; set; }
        public Nullable<int> HostelMasterScore { get; set; }
