...
namespace PillarSalt.BOL
{
    ...
    public partial class Outsourcing_TenderEvaluation
    {
        ...
        public Nullable<bool> NonScoring { get; set; }
        ...
        public virtual Outsourcing_TenderCriteria Outsourcing_TenderCriteria { get; set; }
        public virtual EvaluationWeight EvaluationWeight { get; set; }
    }
}
