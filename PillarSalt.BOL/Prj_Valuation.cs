...
namespace PillarSalt.BOL
{
    ...
    public partial class Prj_Valuation
    {
        public int Id { get; set; }
        public string Description { get; set; }
        public Nullable<int> ProjectCostingId { get; set; }
        public Nullable<decimal> Cost { get; set; }
        public Nullable<decimal> PercentCompletion { get; set; }
        public Nullable<int> ContractID { get; set; }
        public Nullable<System.DateTime> ValuationDate { get; set; }
        public string ValuationStaff { get; set; }
