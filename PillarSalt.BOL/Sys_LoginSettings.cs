...
namespace PillarSalt.BOL
{
    ...
    public partial class Sys_LoginSettings
    {
        public int Id { get; set; }
        public Nullable<int> PasswordExpiration { get; set; }
        public Nullable<int> SessionExpiration { get; set; }
        public Nullable<int> Roles { get; set; }
        public string SuspiciousLoginAction { get; set; }
