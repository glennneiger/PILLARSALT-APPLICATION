...
namespace PillarSalt.BOL
{
    ...
    public partial class TMS_LanguageResources
    {
        ...
        public virtual TMS_Language TMS_Language { get; set; }
        public virtual TMS_LanguageManifest TMS_LanguageManifest { get; set; }
    }
}
